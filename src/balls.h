...
class CirclePhysics : public SDLFramework
{
public:
	...
	virtual bool OnCreate()
		{
			...
			float fLineRadius = 8.0f;
			vecLines.push_back({ 20.0f, 10.0f, 380.0f, 10.0f, fLineRadius });
			vecLines.push_back({ 410.0f, 10.0f, 780.0f, 10.0f, fLineRadius });
			vecLines.push_back({ 20.0f, 590.0f, 380.0f, 590.0f, fLineRadius });
			vecLines.push_back({ 410.0f, 590.0f, 780.0f, 590.0f, fLineRadius });
			vecLines.push_back({ 10.0f, 20.0f, 10.0f, 580.0f, fLineRadius });
			vecLines.push_back({ 790.0f, 20.0f, 790.0f, 580.0f, fLineRadius });
			return true;
		}
	...
	virtual bool OnUpdate(float elapsed_time)
		{
			...
			float fSimElapsedTime = elapsed_time / (float)nSimulationUpdates;
